...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s expocash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  expocash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded expocash transaction") + "\n" +
              "  expocash-tx [options] -create [commands]   " + _("Create hex-encoded expocash transaction") + "\n" +
              "\n";
