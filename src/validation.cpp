...
#if defined(NDEBUG)
# error "ExpoCash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "ExpoCash Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s EXPO additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    nSubsidy >>= halvings;
    if (nHeight == 2) nSubsidy = 15000000 * COIN;
    return nSubsidy;
}
