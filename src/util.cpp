...
const char * const BITCOIN_CONF_FILENAME = "expocash.conf";
const char * const BITCOIN_PID_FILENAME = "expocash.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ExpoCash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ExpoCash";
#else
    // Unix
    return pathRet / ".expocash";
#endif
#endif
}
